...
if __name__ == '__main__':
    ...
    train['word_match_share']=train.apply(word_match_share, axis=1, raw=True)
    test['word_match_share']=test.apply(word_match_share, axis=1, raw=True)
    feats.append('word_match_share')
