...
def retrain_xgb(X, y, params, n_best):
    train = xgb.DMatrix(X, label=y)
    return xgb.train(params, train, n_best)

def predict_xgb(clr, X_test, n_best):
	return clr.predict(xgb.DMatrix(X_test),ntree_limit=n_best)
...
def main():
	...
	n_best = clr.best_iteration
	print("Best iter: {}".format(n_best))
	clr = retrain_xgb(x_train, y_train, params, n_best)
	preds = predict_xgb(clr, x_test, n_best)
